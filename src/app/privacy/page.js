    ...
    <div className="max-w-2xl mx-auto px-4 py-8 sm:py-12 space-y-8">
      <div>
        ...
        <p className="text-xs sm:text-sm text-[#7A7A7A] mt-1">
          jaidee (ใจดี) ถูกออกแบบมาให้เป็นพื้นที่ปลอดภัย 100% สำหรับการดูแลใจตนเอง ภายใต้แนวคิด “ใจดีกับตัวเอง และอารมณ์คือใบไม้ ที่สักวันจะร่วงหล่น”
        </p>
      </div>
      ...
      <div className="space-y-6 text-sm text-[#555] leading-relaxed">
        ...
        <div className="bg-white rounded-2xl p-6 border border-[#EFEAE1] shadow-xs space-y-3">
          ...
          <p>
            jaidee (ใจดี) ไม่ส่งข้อความระบายความรู้สึกของผู้ใช้ไปยัง Third-party AI เพื่อนำไปฝึกสอนโมเดล และไม่มีการเชื่อมต่อกับระบบโฆษณาเพื่อติดตามพฤติกรรม (No Tracking Cookies) พื้นที่นี้เป็นของคุณคนเดียวอย่างแท้จริง
          </p>
        </div>
